...
My pipeline is composed of several modules, and there four of them I want to dig into:
...
\begin{itemize}
    ...
    ensuring the RRT and therefore the robot does not plan paths too close to walls.
\end{itemize}
